...
background: '/img/posts/2022-12-01-Mineral-Mapping/bg.png'
---
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_6_0.png"
         alt="Sebaran data Stream Sediment Sampling">
    <span class="caption text-muted">Sebaran data Stream Sediment Sampling.</span>
</figure>
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_7_0.png"
         alt="Sebaran data Soil Sampling">
    <span class="caption text-muted">Sebaran data Soil Sampling.</span>
</figure>
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_9_0.png"
         alt="Heatmap Stream Sediment Sampling">
    <span class="caption text-muted">Heatmap Stream Sediment Sampling.</span>
</figure>
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_10_0.png"
         alt="Heatmap Soil Sampling">
    <span class="caption text-muted">Heatmap Soil Sampling.</span>
</figure>  
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_12_0.png"
         alt="Screeplot PC Stream Sediment Sampling">
    <span class="caption text-muted">Screeplot PC Stream Sediment Sampling.</span>
</figure> 
...
<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_13_0.png"
         alt="Screeplot PC Soil Sampling">
    <span class="caption text-muted">Screeplot PC Soil Sampling.</span>
</figure>  
...
```
 ...
 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_15_0.png"
         alt="Screeplot Silhouette Score Stream Sediment Sampling">
    <span class="caption text-muted">Screeplot Silhouette Score Stream Sediment Sampling.</span>
</figure> 

 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_15_1.png"
         alt="Screeplot Silhouette Score Stream Sediment Sampling">
    <span class="caption text-muted">Screeplot Silhouette Score Stream Sediment Sampling.</span>
</figure> 
...
```
 ...
 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_1.png"
         alt="Biplot K-Means Clustering PC1 Vs. PC2 Stream Sediment Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC1 Vs. PC2 Stream Sediment Sampling.</span>
</figure> 

 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_2.png"
         alt="Biplot K-Means Clustering PC1 Vs. PC3 Stream Sediment Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC1 Vs. PC3 Stream Sediment Sampling.</span>
</figure> 

 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_3.png"
         alt="Biplot K-Means Clustering PC2 Vs. PC3 Stream Sediment Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC2 Vs. PC3 Stream Sediment Sampling.</span>
</figure> 
 ...
 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_5.png"
         alt="Biplot K-Means Clustering PC1 Vs. PC2 Soil Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC1 Vs. PC2 Soil Sampling.</span>
</figure> 

 <figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_6.png"
         alt="Biplot K-Means Clustering PC1 Vs. PC3 Soil Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC1 Vs. PC3 Soil Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-08-01-Field-Mapping/output_17_7.png"
         alt="Biplot K-Means Clustering PC2 Vs. PC3 Soil Sampling">
    <span class="caption text-muted">Biplot K-Means Clustering PC2 Vs. PC3 Soil Sampling.</span>
</figure> 
...
<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/AuSSS.png"
         alt="Unsur Au">
    <span class="caption text-muted"> Peta Anomali Au Stream Sedimen Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/AgSSS.png"
         alt="Unsur Ag">
    <span class="caption text-muted"> Peta Anomali Ag Stream Sedimen Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/CuSSS.png"
         alt="Unsur Cu">
    <span class="caption text-muted"> Peta Anomali Cu Stream Sedimen Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/MoSSS.png"
         alt="Unsur Mo">
    <span class="caption text-muted"> Peta Anomali Mo Stream Sedimen Sampling.</span>
</figure>

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/PbSSS.png"
         alt="Unsur Pb">
    <span class="caption text-muted"> Peta Anomali Pb Stream Sedimen Sampling.</span>
</figure>

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/SbSSS.png"
         alt="Unsur Sb">
    <span class="caption text-muted"> Peta Anomali Sb Stream Sedimen Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/ZnSSS.png"
         alt="Unsur Zn">
    <span class="caption text-muted"> Peta Anomali Zn Stream Sedimen Sampling.</span>
</figure> 

### B. Peta Anomali Data Soil Sampling
<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/AuSS.png"
         alt="Unsur Au">
    <span class="caption text-muted"> Peta Anomali Au Soil Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/AgSS.png"
         alt="Unsur Ag">
    <span class="caption text-muted"> Peta Anomali Ag Soil Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/CuSS.png"
         alt="Unsur Cu">
    <span class="caption text-muted"> Peta Anomali Cu Soil Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/MoSS.png"
         alt="Unsur Mo">
    <span class="caption text-muted"> Peta Anomali Mo Soil Sampling.</span>
</figure>

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/PbSS.png"
         alt="Unsur Pb">
    <span class="caption text-muted"> Peta Anomali Pb Soil Sampling.</span>
</figure>

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/SbSS.png"
         alt="Unsur Sb">
    <span class="caption text-muted"> Peta Anomali Sb Soil Sampling.</span>
</figure> 

<figure>
    <img src="/img/posts/2022-12-01-Mineral-Mapping/ZnSS.png"
         alt="Unsur Zn">
    <span class="caption text-muted"> Peta Anomali Zn Soil Sampling.</span>
</figure> 